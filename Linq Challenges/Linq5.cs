...
Ale można również zapisać to dużo prościej.

Uzupełnij rozwiązanie tak, aby zwracało prawdę, jeśli pierwszy przekazany argument (ciąg znaków) kończy się drugim argumentem (również ciągiem znaków):
