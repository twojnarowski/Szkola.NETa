int[] array = new int[] { 5, 100, 4, 200, 1, 3, 2, 99, 98, 101, 102, 103, 104, 105, 106, 107, 109, 110, 108, 110, 111, 112, 113, -1, -2, 0, -3, -4, 6, 7 };
var arraySorted = array.OrderBy(x => x).ToArray();
int globalMax = 0;
